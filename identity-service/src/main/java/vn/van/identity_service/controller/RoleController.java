...
public class RoleController {
    ...
    public ResponseEntity<ApiResponse<RoleResponse>> createRole(@RequestBody RoleCreateRequest request) {
        ...
        ApiResponse<RoleResponse> response =
                toApiResponse(ResponseMessage.ROLE_CREATED, roleService.createRole(request));
    ...
    public ResponseEntity<ApiResponse<List<RoleResponse>>> getAllRoles() {
        ...
        ApiResponse<List<RoleResponse>> response =
                toApiResponse(ResponseMessage.ROLE_GET_ALL, roleService.getAllRoles());
        return ResponseEntity.ok(response);
    }

    @PutMapping("/{roleId}")
    public ResponseEntity<ApiResponse<RoleResponse>> updateRole(
            @PathVariable String roleId, @RequestBody RoleUpdateRequest request) {
        log.info("updateRole");
        ApiResponse<RoleResponse> response =
                toApiResponse(ResponseMessage.ROLE_UPDATED, roleService.updateRole(roleId, request));
        return ResponseEntity.ok(response);
    }
